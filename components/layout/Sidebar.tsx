...
const navItems: NavItem[] = [
  ...
  { icon: Calendar, labelKey: "agenda", href: "/agenda" },
  { icon: Bookmark, labelKey: "reservations", href: "/reservas" },
  { icon: Wrench, labelKey: "workshop", href: "/taller" },
  { icon: Megaphone, labelKey: "marketing", href: "/marketing" },
